...
public class EntityWaterGuardian extends AM2Boss {
	...
	protected void initSpecificAI(){
		...
		//todo this.tasks.addTask(4, new EntityAICastSpell<>(this, NPCSpells.instance.waterBolt, 12, 23, 5, BossActions.CASTING));
	...
	protected void dropFewItems(boolean par1, int par2){
		...
		for (int j = 0; j < i; j++){
			//todo this.entityDropItem(new ItemStack(ItemDefs.essence, 1, ArsMagicaAPI.getAffinityRegistry().getId(Affinity.WATER)), 0.0f);
		}
