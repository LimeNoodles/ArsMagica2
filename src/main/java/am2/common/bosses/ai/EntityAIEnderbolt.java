	...
	public void updateTask(){
		...
		if (guardian.getAttackTarget() != null){
			...
			if (guardian.getTicksInCurrentAction() == 7){
				...
				//todo ISpellCaster spell = NPCSpells.instance.enderGuardian_enderBolt.getCapability(SpellCaster.INSTANCE, null);
				//if (spell != null) {
					//todo spell.cast(NPCSpells.instance.enderGuardian_enderBolt, guardian.world, guardian);
				//}
			}else{
				guardian.faceEntity(guardian.getAttackTarget(), 180, 180);
			}
