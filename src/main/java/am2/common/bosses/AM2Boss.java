...
//todo import net.minecraft.entity.boss.EntityDragonPart;
...
public abstract class AM2Boss extends EntityMob implements IEntityMultiPart, IArsMagicaBoss {
	...
	public void onUpdate() {
		...
		//todo if (this.parts != null && this.parts[0] != null && this.parts[0].partName == "defaultBody") {
		...
		if (this.world.isRemote) {
			...
			this.ignoreFrustumCheck = ArsMagica2.proxy.getLocalPlayer().getDistanceSq(this) < 32;
		}
