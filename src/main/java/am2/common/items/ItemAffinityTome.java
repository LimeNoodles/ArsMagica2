...
public class ItemAffinityTome extends ItemArsMagica {
	...
	public ActionResult<ItemStack> onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, EnumHand hand){
		...
		//if (par2World.isRemote)
			//todo return super.onItemRightClick(par1ItemStack, par2World, par3EntityPlayer, hand);
		...
		//if (par1ItemStack.getItemDamage() == ArsMagicaAPI.getAffinityRegistry().getId(Affinity.NONE)){
			...
			//}
		//}else{
			//todo AffinityData.For(par3EntityPlayer).incrementAffinity(ArsMagicaAPI.getAffinityRegistry().getObjectById(par1ItemStack.getItemDamage()), 20);
		//}//

		//todo par1ItemStack.stackSize--;
	...
	public String getItemStackDisplayName(ItemStack stack) {
		...
		//todo return I18n.format("item.arsmagica2:tome.name", aff.getLocalizedName());
		return null;
	}
