...
public class EntityFlicker extends EntityAmbientCreature{
	...
	public EntityFlicker(World par1World){
		...
		//todo setFlickerType(ArsMagicaAPI.getAffinityRegistry().getRandomObject(getRNG()));
	}
	...
	public void setFlickerType(Affinity affinity){
		//todo this.dataManager.set(WATCHER_FLICKERTYPE, ArsMagicaAPI.getAffinityRegistry().getId(affinity));
	}

	public Affinity getFlickerAffinity(){
		//todo return ArsMagicaAPI.getAffinityRegistry().getObjectById(dataManager.get(WATCHER_FLICKERTYPE));
		return null;
	}
	...
	public boolean getCanSpawnHere(){
		...
		if (biome != null){
			...
			//todo Type[] biomeTags = BiomeDictionary.getTypesForBiome(biome);
