...
public class EntityLightMage extends EntityCreature{
	...
	private void initAI(){
		...
		//todo this.tasks.addTask(4, new EntityAIRangedAttackSpell(this, MovementSpeed(), 20, NPCSpells.instance.lightMage_DiminishedAttack));
	...
	public boolean getCanSpawnHere(){
		...
		if (avgLevel == 0){
			...
			if (rand.nextInt(100) < 10){
				//todo this.tasks.addTask(3, new EntityAIRangedAttackSpell(this, MovementSpeed(), 40, NPCSpells.instance.lightMage_NormalAttack));
			...
			if (levelRand > 60){
				//todo this.tasks.addTask(2, new EntityAIRangedAttackSpell(this, MovementSpeed(), 100, NPCSpells.instance.lightMage_AugmentedAttack));
