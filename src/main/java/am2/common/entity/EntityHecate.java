...
public class EntityHecate extends EntityZombie{
	...
	public void onLivingUpdate(){
		if (this.world.isDaytime() && !this.world.isRemote && !this.isDead){
			//todo float f = this.getBrightness(1.0F);
	...
	protected void dropFewItems(boolean bool, int looting){
		//todo if (getRNG().nextInt(10) == 5)
			//todo this.entityDropItem(new ItemStack(ItemDefs.essence, 1, ArsMagicaAPI.getAffinityRegistry().getId(Affinity.ENDER)), 0.0f);
	}
