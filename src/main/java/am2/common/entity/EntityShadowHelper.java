...
public class EntityShadowHelper extends EntityLiving{
	...
	//todo private static final DataParameter<Optional<ItemStack>> DW_SEARCH_ITEM = EntityDataManager.createKey(EntityShadowHelper.class, DataSerializers.ITEM_STACK.OPTIONAL_ITEM_STACK); //what are we currently looking for?
	...
	//todo private static final DataParameter<Optional<ItemStack>> DW_HELD_ITEM = EntityDataManager.createKey(EntityShadowHelper.class, DataSerializers.OPTIONAL_ITEM_STACK); //current held item
	...
	protected void entityInit(){
		...
		//todo this.dataManager.register(DW_SEARCH_ITEM, Optional.of(new ItemStack(Items.APPLE)));
		...
		//todo this.dataManager.register(DW_HELD_ITEM, Optional.of(new ItemStack(Items.PAPER)));
	...
	public void setSearchLocationAndItem(AMVector3 location, ItemStack item){
		...
		//todo this.dataManager.set(DW_SEARCH_ITEM, Optional.of(item));
	...
	public ItemStack getSearchItem(){
		//todo return this.dataManager.get(DW_SEARCH_ITEM).orNull();
		return null;
	}

	public void setHeldItem(ItemStack item){
		//todo this.dataManager.set(DW_HELD_ITEM, Optional.of(item));
	}
	...
	public ItemStack getHeldItemMainhand(){
		//todo return this.dataManager.get(DW_HELD_ITEM).orNull();
		return null;
	}
