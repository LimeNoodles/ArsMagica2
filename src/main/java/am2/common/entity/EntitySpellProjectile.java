		...
		try {
			...
			if (mop != null && mop.typeOfHit.equals(RayTraceResult.Type.BLOCK)) {
				...
				for (Entity entity : list) {
					//todo if (entity instanceof EntityDragonPart && ((EntityDragonPart)entity).entityDragonObj instanceof EntityLivingBase)
						//todo entity = (EntityLivingBase)((EntityDragonPart)entity).entityDragonObj;
